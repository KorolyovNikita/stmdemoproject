...
{
  // control register 1
  struct CR1 : Register<0x40000000, ReadWriteMode, 0x0>
  {
    // Clock division
  ...
  // control register 2
  struct CR2 : Register<0x40000004, ReadWriteMode, 0x0>
  {
    // TI1 selection
  ...
  struct SMCR : Register<0x40000008, ReadWriteMode, 0x0>
  {
  ...
  struct DIER : Register<0x4000000c, ReadWriteMode, 0x0>
  {
  ...
  // status register
  struct SR : Register<0x40000010, ReadWriteMode, 0x0>
  {
  ...
  struct EGR : Register<0x40000014, WriteMode, 0x0>
  {
    // Trigger generation
  ...
  struct CCMR1_Output : Register<0x40000018, ReadWriteMode, 0x0>
  {
    // OC2CE
  ...
  struct CCMR1_Input : Register<0x40000018, ReadWriteMode, 0x0>
  {
  ...
  struct CCMR2_Output : Register<0x4000001c, ReadWriteMode, 0x0>
  {
    // O24CE
  ...
  struct CCMR2_Input : Register<0x4000001c, ReadWriteMode, 0x0>
  {
  ...
  struct CCER : Register<0x40000020, ReadWriteMode, 0x0>
  {
  ...
  // counter
  struct CNT : Register<0x40000024, ReadWriteMode, 0x0>
  {
    // High counter value
  ...
  // prescaler
  struct PSC : Register<0x40000028, ReadWriteMode, 0x0>
  {
    // Prescaler value
  ...
  struct ARR : Register<0x4000002c, ReadWriteMode, 0x0>
  {
  ...
  struct CCR1 : Register<0x40000034, ReadWriteMode, 0x0>
  {
  ...
  struct CCR2 : Register<0x40000038, ReadWriteMode, 0x0>
  {
  ...
  struct CCR3 : Register<0x4000003c, ReadWriteMode, 0x0>
  {
  ...
  struct CCR4 : Register<0x40000040, ReadWriteMode, 0x0>
  {
    // High Capture/Compare value
  ...
  struct DCR : Register<0x40000048, ReadWriteMode, 0x0>
  {
    // DMA burst length
  ...
  struct DMAR : Register<0x4000004c, ReadWriteMode, 0x0>
  {
  ...
  struct OR : Register<0x40000050, ReadWriteMode, 0x0>
  {
    // Timer Input 4 remap
    struct ITR1_RMP : RegisterField<OR, 10, 2, ReadWriteMode>
    {
    };
  };
