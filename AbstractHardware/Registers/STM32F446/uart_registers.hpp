...
struct UART4
{
  ...
  // Status register
  struct SR : Register<0x40004c00, ReadWriteMode, 0xc00000>
  {
  ...
  // Data register
  struct DR : Register<0x40004c04, ReadWriteMode, 0x0>
  {
    // Data value
  ...
  // Baud rate register
  struct BRR : Register<0x40004c08, ReadWriteMode, 0x0>
  {
  ...
  // Control register 1
  struct CR1 : Register<0x40004c0c, ReadWriteMode, 0x0>
  {
    // Oversampling mode
  ...
  // Control register 2
  struct CR2 : Register<0x40004c10, ReadWriteMode, 0x0>
  {
    // LIN mode enable
  ...
  // Control register 3
  struct CR3 : Register<0x40004c14, ReadWriteMode, 0x0>
  {
...
struct UART5
{
  ...
  // Status register
  struct SR : Register<0x40005000, ReadWriteMode, 0xc00000>
  {
    // LIN break detection flag
    struct LBD : RegisterField<SR, 8, 1, ReadWriteMode>
    {
  ...
  // Data register
  struct DR : Register<0x40005004, ReadWriteMode, 0x0>
  {
    // Data value
    struct _DR : RegisterField<DR, 0, 9, ReadWriteMode>
    {
  ...
  // Baud rate register
  struct BRR : Register<0x40005008, ReadWriteMode, 0x0>
  {
    // mantissa of USARTDIV
    struct DIV_Mantissa : RegisterField<BRR, 4, 12, ReadWriteMode>
    {
  ...
  // Control register 1
  struct CR1 : Register<0x4000500c, ReadWriteMode, 0x0>
  {
    // Oversampling mode
    struct OVER8 : RegisterField<CR1, 15, 1, ReadWriteMode>
    {
  ...
  // Control register 2
  struct CR2 : Register<0x40005010, ReadWriteMode, 0x0>
  {
    // LIN mode enable
    struct LINEN : RegisterField<CR2, 14, 1, ReadWriteMode>
    {
  ...
  // Control register 3
  struct CR3 : Register<0x40005014, ReadWriteMode, 0x0>
  {
    // One sample bit method enable
    struct ONEBIT : RegisterField<CR3, 11, 1, ReadWriteMode>
    {
