...
{
  // control register 1
  struct CR1 : Register<0x40014800, ReadWriteMode, 0x0>
  {
    // Clock division
  ...
  struct DIER : Register<0x4001480c, ReadWriteMode, 0x0>
  {
  ...
  // status register
  struct SR : Register<0x40014810, ReadWriteMode, 0x0>
  {
  ...
  struct EGR : Register<0x40014814, WriteMode, 0x0>
  {
  ...
  struct CCMR1_Output : Register<0x40014818, ReadWriteMode, 0x0>
  {
  ...
  struct CCMR1_Input : Register<0x40014818, ReadWriteMode, 0x0>
  {
  ...
  struct CCER : Register<0x40014820, ReadWriteMode, 0x0>
  {
  ...
  // counter
  struct CNT : Register<0x40014824, ReadWriteMode, 0x0>
  {
    // counter value
  ...
  // prescaler
  struct PSC : Register<0x40014828, ReadWriteMode, 0x0>
  {
    // Prescaler value
  ...
  struct ARR : Register<0x4001482c, ReadWriteMode, 0x0>
  {
    // Auto-reload value
  ...
  struct CCR1 : Register<0x40014834, ReadWriteMode, 0x0>
  {
  ...
  // option register
  struct OR : Register<0x40014850, ReadWriteMode, 0x0>
  {
    // Input 1 remapping capability
    struct RMP : RegisterField<OR, 0, 2, ReadWriteMode>
    {
    };
  };
