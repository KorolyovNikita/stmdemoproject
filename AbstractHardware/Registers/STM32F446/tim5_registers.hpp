...
{
  // control register 1
  struct CR1 : Register<0x40000c00, ReadWriteMode, 0x0>
  {
    // Clock division
  ...
  // control register 2
  struct CR2 : Register<0x40000c04, ReadWriteMode, 0x0>
  {
    // TI1 selection
  ...
  struct SMCR : Register<0x40000c08, ReadWriteMode, 0x0>
  {
  ...
  struct DIER : Register<0x40000c0c, ReadWriteMode, 0x0>
  {
  ...
  // status register
  struct SR : Register<0x40000c10, ReadWriteMode, 0x0>
  {
  ...
  struct EGR : Register<0x40000c14, WriteMode, 0x0>
  {
    // Trigger generation
  ...
  struct CCMR1_Output : Register<0x40000c18, ReadWriteMode, 0x0>
  {
    // OC2CE
  ...
  struct CCMR1_Input : Register<0x40000c18, ReadWriteMode, 0x0>
  {
  ...
  struct CCMR2_Output : Register<0x40000c1c, ReadWriteMode, 0x0>
  {
    // O24CE
  ...
  struct CCMR2_Input : Register<0x40000c1c, ReadWriteMode, 0x0>
  {
  ...
  struct CCER : Register<0x40000c20, ReadWriteMode, 0x0>
  {
  ...
  // counter
  struct CNT : Register<0x40000c24, ReadWriteMode, 0x0>
  {
    // High counter value
  ...
  // prescaler
  struct PSC : Register<0x40000c28, ReadWriteMode, 0x0>
  {
    // Prescaler value
  ...
  struct ARR : Register<0x40000c2c, ReadWriteMode, 0x0>
  {
  ...
  struct CCR1 : Register<0x40000c34, ReadWriteMode, 0x0>
  {
  ...
  struct CCR2 : Register<0x40000c38, ReadWriteMode, 0x0>
  {
  ...
  struct CCR3 : Register<0x40000c3c, ReadWriteMode, 0x0>
  {
  ...
  struct CCR4 : Register<0x40000c40, ReadWriteMode, 0x0>
  {
    // High Capture/Compare value
  ...
  struct DCR : Register<0x40000c48, ReadWriteMode, 0x0>
  {
    // DMA burst length
  ...
  struct DMAR : Register<0x40000c4c, ReadWriteMode, 0x0>
  {
  ...
  struct OR : Register<0x40000c50, ReadWriteMode, 0x0>
  {
    // Timer Input 4 remap
    struct IT4_RMP : RegisterField<OR, 6, 2, ReadWriteMode>
    {
    };
  };
